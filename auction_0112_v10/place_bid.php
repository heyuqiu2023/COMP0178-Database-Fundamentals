...
try {
  ...
  // Note: Must set isolation level before starting transaction (MySQL does not allow changing it mid‑transaction)
  ...
  $stmt->execute([$bidder_id, $auction_id]);
  ...
  echo '<p><a href="listing.php?auction_id=' . urlencode((string)$auction_id) . '">Return to listing</a> or <a href="browse.php">continue browsing</a>.</p>';
