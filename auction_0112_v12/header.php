...
if (!empty($_SESSION['logged_in']) && $_SESSION['logged_in'] && ($_SESSION['account_type'] ?? '') === 'buyer') {
  // 买家菜单：My Bids + My Watchlist + Recommended
...
if (!empty($_SESSION['logged_in']) && $_SESSION['logged_in'] && ($_SESSION['account_type'] ?? '') === 'seller') {
  // 卖家菜单：My Listings + Create auction
